...
ffs_super.o: ffs_super.c ffs_super.h disk_driver.h ffs_inode.h ffs_errno.h
	$(CC) $(CFLAGS) -c ffs_super.c

ffs_inode.o: ffs_inode.c ffs_super.h disk_driver.h ffs_inode.h ffs_errno.h
	$(CC) $(CFLAGS) -c ffs_inode.c

clean:
	rm -f tstSB tstSB.o disk_driver.o ffs_bytemap.o ffs_super.o ffs_inode.o
